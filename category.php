        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    ...
                    $query = "SELECT posts.postTitle , posts.postImage ,posts.id, posts.postAuthor , posts.postContent , posts.postDate , categories.categoryName  FROM posts INNER JOIN categories on categories.id = posts.postCategory  WHERE postCategory = '$cat' ORDER BY posts.id DESC";
                    $result = mysqli_query($conn,$query);
                    while ($row = mysqli_fetch_assoc($result)){
                        ?>
                    <div class="post">
                        <div class="post-image">
                            <a href="post.php?id=<?php echo $row['id'];?>"><img src="upload/<?php echo $row['postImage'];?>"></a>
                        </div>
